  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rouded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        <div className='hidden sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 borber-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
        ...
        {appointments.map((item, index) => (
          <div className="flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50" key={index}>
            ...
            <div className='flex items-center gap-2'>
              <img className='w-8 sm:w-12 aspect-[1/1] object-contain rounded-full bg-gray-200' src={item.carData.image} alt="" />
              <p>{item.carData.name.length >= 14 ? item.carData.name.slice(0, 14) + "..." : item.carData.name}</p>
            </div>
